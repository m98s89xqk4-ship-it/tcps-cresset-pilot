    ...
    <div className="page-shell page-background">
      <div className="mx-auto max-w-2xl">
        ...
        <div className="mb-6 space-y-3">
          <div className={`grid grid-cols-1 gap-2 ${prevSession && nextSession ? 'sm:grid-cols-2' : 'sm:grid-cols-1'}`}>
            {prevSession && (
        ...
        <div className="tcps-panel p-4">
          ...
          <div className="tcps-progress-track mb-2 h-2">
            <div className="tcps-progress-fill h-2 transition-all duration-300" style={{ width: `${(sessionNum / 15) * 100}%` }} />
          </div>
